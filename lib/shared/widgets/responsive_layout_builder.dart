...
import '../helpers/layout/breakpoints.dart';
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        if (constraints.maxWidth <= DropAndGoBreakpoints.small) {
          return small(context, child);
        }
        if (constraints.maxWidth <= DropAndGoBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        if (constraints.maxWidth <= DropAndGoBreakpoints.large) {
