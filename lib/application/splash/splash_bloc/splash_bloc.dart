...
class SplashBloc extends Bloc<SplashEvent, SplashState>{
  ...
  Future<void> _onCheckAuthState(CheckAuthState event, Emitter<SplashState> emit) async{
  ...
  Future<void> _onGetUserSettings(GetUserSettings event, Emitter<SplashState> emit) async{
  }
}